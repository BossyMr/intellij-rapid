...
public class RapidTokenType extends IElementType {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(ALIAS_KEYWORD, AND_KEYWORD, BACKWARD_KEYWORD, CASE_KEYWORD,
            ...
            ENDTEST_KEYWORD, ENDTRAP_KEYWORD, ENDWHILE_KEYWORD, ERROR_KEYWORD, EXIT_KEYWORD, FOR_KEYWORD,
            FROM_KEYWORD, FUNC_KEYWORD, GOTO_KEYWORD, IF_KEYWORD, INOUT_KEYWORD, MOD_KEYWORD,
            ...
            SYSMODULE_KEYWORD, TEST_KEYWORD, THEN_KEYWORD, TO_KEYWORD, TRAP_KEYWORD, TRYNEXT_KEYWORD,
