...
import io.github.bossymr.language.psi.RapidBinaryExpression;
import io.github.bossymr.language.psi.RapidElementTypes;
import io.github.bossymr.language.psi.RapidUnaryExpression;
...
public abstract class RapidExpressionElement extends RapidCompositeElement {
    ...
    private static boolean getParenthesis(@NotNull ASTNode oldElement, @NotNull ASTNode newElement) {
        ...
        if (TokenSet.create(INDEX_EXPRESSION, FUNCTION_CALL_EXPRESSION, AGGREGATE_EXPRESSION, PARENTHESISED_EXPRESSION,
                BOOL_LITERAL_EXPRESSION, INTEGER_LITERAL_EXPRESSION, STRING_LITERAL_EXPRESSION).contains(elementType)) {
            return false;
        }
