...
public class RapidHighlighterAnnotator extends RapidElementVisitor implements Annotator, DumbAware {
    ...
    public void visitParameterSymbol(@NotNull PsiElement identifier, @NotNull RapidParameter parameter) {
        RapidColor color = parameter.getParameterGroup().isOptional() ? RapidColor.OPTIONAL_PARAMETER : RapidColor.PARAMETER;
