...
public class CollectionModel extends Model {
    ...
    public CollectionModel(@NotNull String title, @NotNull String type, @NotNull Map<String, String> fields, @NotNull Map<String, URI> paths, @NotNull List<Model> models) {
