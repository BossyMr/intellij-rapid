...
public interface RapidElementTypes {
    ...
    TokenSet STATEMENTS = TokenSet.create(ASSIGNMENT_STATEMENT, PROCEDURE_CALL_STATEMENT, CONNECT_STATEMENT, EXIT_STATEMENT, GOTO_STATEMENT, RAISE_STATEMENT, RETRY_STATEMENT, RETURN_STATEMENT, TRY_NEXT_STATEMENT, IF_STATEMENT, FOR_STATEMENT, WHILE_STATEMENT, TEST_STATEMENT);
