...
public final class RapidFieldIndex extends StringStubIndexExtension<PhysicalField> {
    ...
    public Collection<PhysicalField> get(@NotNull String name, @NotNull Project project, @NotNull GlobalSearchScope scope) {
