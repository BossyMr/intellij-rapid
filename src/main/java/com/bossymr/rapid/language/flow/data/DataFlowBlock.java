...
public record DataFlowBlock(@NotNull BasicBlock basicBlock,
    ...
    public @NotNull Constraint getConstraint(@NotNull Value.Variable variable) {
        List<Constraint> constraints = states.stream()
                .flatMap(state -> state.getConditions(variable).stream())
    ...
    private class ExpressionVisitor extends ControlFlowVisitor {
        ...
        private @NotNull NumericConstraint calculateNumberConstraint(@NotNull Operator.BinaryOperator operator, @NotNull NumericConstraint left, @NotNull NumericConstraint right) {
            return switch (operator) {
        ...
        private @NotNull BooleanConstraint calculateBooleanRangeConstraint(@NotNull Operator.BinaryOperator operator, @NotNull NumericConstraint left, @NotNull NumericConstraint right) {
